...
pub fn our_pipeline() -> Pipeline {
  [
    ...
    [
      ...
      dl.append_attribute(#("Section", "id", "section-::++SectionCounter", infra.GoBack)),
      dl.timer(),
      dl.prepend_attribute__outside(#("Chapter", "path", "/article/chapter::øøChapterCounter", infra.GoBack), ["Bootcamp"]),
      dl.prepend_attribute__outside(#("Bootcamp", "path", "/article/bootcamp::øøBootcampCounter", infra.GoBack), ["Chapter"]),
