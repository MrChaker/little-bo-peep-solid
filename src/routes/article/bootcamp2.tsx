    ...
    {showMore() && <>
      ...
      <Section id="section-2">
        ...
        <OuterP>
          ...
          Moreover, (
          <InChapterLink
            href="/article/bootcamp2?id=_1_9918"
        ...
        <OuterP>
          ...
          in (
          <InChapterLink
            href="/article/bootcamp2?id=_2_6421"
            class="handle-in-chapter-link">
            AA
          </InChapterLink>
        ...
        <Exercise number={15}>
          ...
          <Solution>
            <OuterP>
              ...
              {" "} (as in {" "}
              <InChapterLink
                href="/article/bootcamp2?id=_3_744"
                class="handle-in-chapter-link">
                Exercise 14
              </InChapterLink>
              ):
