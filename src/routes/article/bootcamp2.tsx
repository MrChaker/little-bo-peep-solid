    ...
    { showMore() && <>
      ...
      <Section id="section-2">
        ...
        <VerticalChunk>
          ...
          Moreover, (
          <InChapterLink
            href="/article/bootcamp2?id=_1_1498"
        ...
        <VerticalChunk>
          ...
          in (
          <InChapterLink
            href="/article/bootcamp2?id=_2_7397"
            class="handle-in-chapter-link">
            AA
          </InChapterLink>
        ...
        <Exercise exercise_number={15}>
          ...
          <Solution solution_number={15}>
            <VerticalChunk>
              ...
              {" "}(as in{" "}
              <InChapterLink
                href="/article/bootcamp2?id=_3_7826"
                class="handle-in-chapter-link">
                Exercise 14
              </InChapterLink>
              ):
