...
const SectionsBreadcrumbsContainer = (props: ParentProps) => {
  ...
  createEffect(() => {
    store.route;
    const list = document.querySelector("#breadcrumbs-list");
    if (list) {
      const prevAndNext = list.childNodes.item(0);
      list.innerHTML = "";
      list.appendChild(prevAndNext);
    }
    setTimeout(() => {
...
export default SectionsBreadcrumbsContainer;
